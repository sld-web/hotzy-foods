    ...
    <div className="max-w-container mx-auto px-4 md:px-margin-desktop py-stack-lg">
      ...
      <section className="text-center mb-16">
        ...
        <p className="text-body-lg text-on-surface-variant max-w-2xl mx-auto">
          Born in Sri Lanka in 2022, Hotzy Foods was founded by Amali and Chamath with a mission to bring
          bold Sri Lankan flavors to the world.
        </p>
      </section>
      ...
      <section className="mb-16">
        ...
        <div className="space-y-4">
          {[
            { year: '2022', text: 'Founded by Amali & Chamath during Sri Lanka economic crisis. Built our own polytunnel to grow Scotch Bonnet peppers.' },
            { year: '2023', text: 'Launched Snake Bite (pineapple-based hot sauce). Went viral on TikTok. First export order to Australia.' },
            { year: '2024', text: 'Expanded product line. Won Best National Industry Brand 2024 and NEDA Bronze Award. Achieved ISO 22000:2018 certification.' },
            { year: '2025', text: 'Launched jams, Asian sauces, and gift packs. Growing export markets.' },
          ].map((item) => (
            <div key={item.year} className="flex gap-4 p-4 bg-white rounded-xl border border-surface-container">
              <span className="text-label-sm text-primary font-bold shrink-0 w-12">{item.year}</span>
      ...
      <section className="mb-16">
        ...
        <div className="grid md:grid-cols-4 gap-4">
          {heatLevels.map((level) => (
            <div key={level.name} className="bg-white rounded-xl border border-surface-container p-5 text-center">
      ...
      <section className="mb-16">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {[
            { name: 'Amali', role: 'Co-Founder & Flavor Architect' },
            { name: 'Chamath', role: 'Co-Founder & Heat Engineer' },
          ].map((member) => (
            <div key={member.name} className="bg-white rounded-xl border border-surface-container p-6 flex items-center gap-4">
              <div className="w-16 h-16 rounded-full bg-surface-gray flex items-center justify-center shrink-0">
      ...
      <section className="text-center py-stack-lg bg-primary/5 rounded-xl p-8">
        ...
        <p className="text-body-lg text-on-surface-variant max-w-2xl mx-auto">
          ...
          We are committed to honesty, quality, and bringing Sri Lankan flavors to the world.
        </p>
      </section>
    </div>
  );
